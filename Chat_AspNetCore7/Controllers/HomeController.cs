...
namespace Chat_AspNetCore7.Controllers
{
	public class HomeController : Controller
	{
		...
		public HomeController(IServiceManager serviceManager, UserManager<CustomUser> userManager, SignInManager<CustomUser> signInManager, IConfiguration configuration, IHttpClientFactory httpClientFactory)
		{
